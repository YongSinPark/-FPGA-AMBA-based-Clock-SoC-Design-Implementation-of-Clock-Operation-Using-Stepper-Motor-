...
// Instantiation of Axi Bus Interface S00_AXI
	AXI4_TEMPLATE_v1_0_S00_AXI # ( 
		...
		.o_hope_frequency1(w_hope_frequency1),
		.o_hope_frequency2(w_hope_frequency2),
		.o_mode(w_mode),
		.o_dir(w_dir),
		.o_step(w_step),
    ...
    .i_hope_frequency1(w_hope_frequency1),
    .i_hope_frequency2(w_hope_frequency2),
    .i_mode(w_mode),
    .i_dir(w_dir),
    .i_step(w_step),
